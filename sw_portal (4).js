...
const CACHE_VERSION = 'atlas-portal-v5-autoupdate';

// ── Nome exato do arquivo HTML no GitHub Pages ────────────────────────────
// Altere aqui se renomear o arquivo
const PORTAL_FILE = './portal_v2_pwa.html';
...
// ── Mensagem da página: ativar a versão nova imediatamente ────────────────
// A página manda isto quando detecta que há um SW novo instalado esperando.
// skipWaiting() faz o SW novo assumir sem esperar todas as abas fecharem.
self.addEventListener('message', e => {
  if (e.data && e.data.type === 'ATIVAR_AGORA') {
    self.skipWaiting();
  }
});
